...
namespace Engine::Renderer
{
    ...
    void Renderer::DrawCube(float angleDegrees, float x, float y, float z) const
    {
    ...
    void Renderer::DrawPyramid(float angleDegrees, float x, float y, float z) const
    {
        glMatrixMode(GL_PROJECTION);
        glLoadIdentity();
